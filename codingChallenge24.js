...
// } //this solution is really slow. a loop inside of a loop..weird time complexity

function missingNum(arr, mixArr){
    //look for same lengths
    if(arr.length === mixArr.length){
      return 0
    }else{
      //reduce then subtrace [1,2,3] [2,3] ==the sum is 6 -5 =1 so 1 is the missing num
